...
public class Bicicleta {
    ...
    private Bicicleta(String referencia, String marca, String modelo, double peso, double tamanyoRuedas, boolean motor, String fechaFabrica){
    ...
    public Bicicleta(String marca, String modelo, double peso, double tamanyoRuedas, boolean motor, String fechaFabrica) {
        this(String.valueOf(++cont), marca, modelo, peso, tamanyoRuedas, motor, fechaFabrica);
    }

    public Bicicleta(Bicicleta b1){
        this(b1.getReferecncia(), b1.getMarca(), b1.getModelo(), b1.getPeso(), b1.getTamanyoRuedas(), b1.isMotor(), b1.getFechaFabrica());
    }
    ...
    public String toString() {
        return "Bicicleta [referecncia=" + referecncia + ", marca=" + marca + ", modelo=" + modelo + ", peso=" + peso
                + ", tamañoRuedas=" + tamanyoRuedas + ", motor=" + motor + ", fechaFabrica=" + fechaFabrica
